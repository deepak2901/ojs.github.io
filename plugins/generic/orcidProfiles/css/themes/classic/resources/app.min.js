!function(t, e) {
    ...
    function _(t, e, i) {
        var s, o = (e = e || n).createElement("script");
        if (o.text = t,
        i)
            for (s in v)
                i[s] && (o[s] = i[s]);
    ...
    y.extend = y.fn.extend = function() {
        ...
        a--); a < l; a++)
            if (null != (t = arguments[a]))
                for (e in t)
                    i = r[e],
                    r !== (n = t[e]) && (h && n && (y.isPlainObject(n) || (s = Array.isArray(n))) ? (s ? (s = !1,
                    o = i && Array.isArray(i) ? i : []) : o = i && y.isPlainObject(i) ? i : {},
                    r[e] = y.extend(h, o, n)) : void 0 !== n && (r[e] = n));
        return r
    }
    ,
    y.extend({
        ...
        isPlainObject: function(t) {
            var e, i;
            return !(!t || "[object Object]" !== c.call(t)) && (!(e = s(t)) || "function" == typeof (i = u.call(e, "constructor") && e.constructor) && d.call(i) === p)
        },
        ...
        makeArray: function(t, e) {
            var i = e || [];
            return null != t && (C(Object(t)) ? y.merge(i, "string" == typeof t ? [t] : t) : a.call(i, t)),
            i
        },
    ...
    var x = function(t) {
        var e, i, n, s, o, r, a, l, h, c, u, d, p, f, g, m, v, _, b, y = "sizzle" + 1 * new Date, w = t.document, C = 0, x = 0, T = rt(), k = rt(), D = rt(), E = function(t, e) {
            return t === e && (u = !0),
            0
        }, I = {}.hasOwnProperty, S = [], A = S.pop, N = S.push, P = S.push, O = S.slice, M = function(t, e) {
            for (var i = 0, n = t.length; i < n; i++)
                if (t[i] === e)
                    return i;
            return -1
        }, H = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", L = "[\\x20\\t\\r\\n\\f]", W = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", F = "\\[" + L + "*(" + W + ")(?:" + L + "*([*^$|!~]?=)" + L + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + W + "))|)" + L + "*\\]", R = ":(" + W + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + F + ")*)|.*)\\)|)", z = new RegExp(L + "+","g"), j = new RegExp("^" + L + "+|((?:^|[^\\\\])(?:\\\\.)*)" + L + "+$","g"), q = new RegExp("^" + L + "*," + L + "*"), B = new RegExp("^" + L + "*([>+~]|" + L + ")" + L + "*"), Y = new RegExp("=" + L + "*([^\\]'\"]*?)" + L + "*\\]","g"), U = new RegExp(R), K = new RegExp("^" + W + "$"), $ = {
            ID: new RegExp("^#(" + W + ")"),
            CLASS: new RegExp("^\\.(" + W + ")"),
            TAG: new RegExp("^(" + W + "|[*])"),
            ATTR: new RegExp("^" + F),
        ...
        }, V = /^(?:input|select|textarea|button)$/i, X = /^h\d$/i, G = /^[^{]+\{\s*\[native \w/, Q = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, J = /[+~]/, Z = new RegExp("\\\\([\\da-f]{1,6}" + L + "?|(" + L + ")|.)","ig"), tt = function(t, e, i) {
            var n = "0x" + e - 65536;
        ...
        try {
            P.apply(S = O.call(w.childNodes), w.childNodes),
        ...
        function ot(t, e, n, s) {
            var o, a, h, c, u, f, v, _ = e && e.ownerDocument, C = e ? e.nodeType : 9;
            if (n = n || [],
            ...
            g)) {
                ...
                if (i.qsa && !D[t + " "] && (!m || !m.test(t))) {
                    if (1 !== C)
                        ...
                        for ((c = e.getAttribute("id")) ? c = c.replace(et, it) : e.setAttribute("id", c = y),
                        a = (f = r(t)).length; a--; )
                            f[a] = "#" + c + " " + vt(f[a]);
                        v = f.join(","),
        ...
        d = ot.setDocument = function(t) {
            ...
            (i.qsa = G.test(p.querySelectorAll)) && (lt(function(t) {
                ...
                t.querySelectorAll("[msallowcapture^='']").length && m.push("[*^$]=" + L + "*(?:''|\"\")"),
                t.querySelectorAll("[selected]").length || m.push("\\[" + L + "*(?:value|" + H + ")"),
            ...
            lt(function(t) {
                ...
                t.querySelectorAll("[name=d]").length && m.push("name" + L + "*[*^$|!~]?="),
            ...
            E = e ? function(t, e) {
                ...
                return n || (1 & (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !i.sortDetached && e.compareDocumentPosition(t) === n ? t === p || t.ownerDocument === w && b(w, t) ? -1 : e === p || e.ownerDocument === w && b(w, e) ? 1 : c ? M(c, t) - M(c, e) : 0 : 4 & n ? -1 : 1)
            }
            : function(t, e) {
                if (t === e)
                    return u = !0,
                ...
                if (!s || !o)
                    return t === p ? -1 : e === p ? 1 : s ? -1 : o ? 1 : c ? M(c, t) - M(c, e) : 0;
                if (s === o)
                    return ct(t, e);
        ...
        (n = ot.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, i = !t[6] && t[2];
                    return $.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && U.test(i) && (e = r(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e),
                    t[2] = i.slice(0, e)),
                    t.slice(0, 3))
                }
            },
            filter: {
                ...
                ATTR: function(t, e, i) {
                    return function(n) {
                        var s = ot.attr(n, t);
                        return null == s ? "!=" === e : !e || (s += "",
                        "=" === e ? s === i : "!=" === e ? s !== i : "^=" === e ? i && 0 === s.indexOf(i) : "*=" === e ? i && s.indexOf(i) > -1 : "$=" === e ? i && s.slice(-i.length) === i : "~=" === e ? (" " + s.replace(z, " ") + " ").indexOf(i) > -1 : "|=" === e && (s === i || s.slice(0, i.length + 1) === i + "-"))
                    }
                },
                CHILD: function(t, e, i, n, s) {
                    ...
                    : function(e, i, l) {
                        ...
                        if (m) {
                            ...
                            r && _) {
                                for (b = (p = (h = (c = (u = (d = m)[y] || (d[y] = {}))[d.uniqueID] || (u[d.uniqueID] = {}))[t] || [])[0] === C && h[1]) && h[2],
                                d = p && m.childNodes[p]; d = ++p && d && d[g] || (b = p = 0) || f.pop(); )
                                    if (1 === d.nodeType && ++b && d === e) {
                                        c[t] = [C, p, b];
                                        break
                                    }
                            } else if (_ && (b = p = (h = (c = (u = (d = e)[y] || (d[y] = {}))[d.uniqueID] || (u[d.uniqueID] = {}))[t] || [])[0] === C && h[1]),
                            !1 === b)
                                for (; (d = ++p && d && d[g] || (b = p = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++b || (_ && ((c = (u = d[y] || (d[y] = {}))[d.uniqueID] || (u[d.uniqueID] = {}))[t] = [C, b]),
                                d !== e)); )
                                    ;
        ...
        function _t(t, e, i) {
            ...
            : function(e, i, l) {
                ...
                if (l) {
                    ...
                    for (; e = e[n]; )
                        if (1 === e.nodeType || r)
                            if (c = (u = e[y] || (e[y] = {}))[e.uniqueID] || (u[e.uniqueID] = {}),
                            s && s === e.nodeName.toLowerCase())
                                e = e[n] || e;
                            else {
                                if ((h = c[o]) && h[0] === C && h[1] === a)
                                    return d[2] = h[2];
                                if (c[o] = d,
                                d[2] = t(e, i, l))
                                    return !0
        ...
        function Ct(t) {
            for (var e, i, s, o = t.length, r = n.relative[t[0].type], a = r || n.relative[" "], l = r ? 1 : 0, c = _t(function(t) {
                return t === e
            }, a, !0), u = _t(function(t) {
                return M(e, t) > -1
                ...
                if (i = n.relative[t[l].type])
                    ...
                    if ((i = n.filter[t[l].type].apply(null, t[l].matches))[y]) {
                        ...
                        return wt(l > 1 && bt(d), l > 1 && vt(t.slice(0, l - 1).concat({
                            value: " " === t[l - 2].type ? "*" : ""
                        })).replace(j, "$1"), i, l < s && Ct(t.slice(l, s)), s < o && Ct(t = t.slice(s)), s < o && vt(t))
                    }
                    d.push(i)
                }
            return bt(d)
        ...
        r = ot.tokenize = function(t, e) {
            ...
            h = n.preFilter; a; ) {
                ...
                a = a.slice(i.length)),
                n.filter)
                    !(s = $[r].exec(a)) || h[r] && !(s = h[r](s)) || (i = s.shift(),
                    o.push({
                        value: i,
                        type: r,
                        matches: s
        ...
        a = ot.compile = function(t, e) {
            ...
            if (!a) {
                for (e || (e = r(t)),
                i = e.length; i--; )
                    (a = Ct(e[i]))[y] ? s.push(a) : o.push(a);
                (a = D(t, function(t, e) {
                    var i = e.length > 0
                      , s = t.length > 0
                      , o = function(o, r, a, l, c) {
                        var u, f, m, v = 0, _ = "0", b = o && [], y = [], w = h, x = o || s && n.find.TAG("*", c), T = C += null == w ? 1 : Math.random() || .1, k = x.length;
                        for (c && (h = r === p || r || c); _ !== k && null != (u = x[_]); _++) {
                            if (s && u) {
                                for (f = 0,
                                r || u.ownerDocument === p || (d(u),
                                a = !g); m = t[f++]; )
                                    if (m(u, r || p, a)) {
                                        l.push(u);
                                        break
                        ...
                        i && _ !== v) {
                            ...
                            if (o) {
                                if (v > 0)
                                    for (; _--; )
                                        b[_] || y[_] || (y[_] = A.call(l));
                                y = yt(y)
                            }
                            P.apply(l, y),
                            c && !o && y.length > 0 && v + e.length > 1 && ot.uniqueSort(l)
                        }
                        return c && (C = T,
                        h = w),
                        b
        ...
        l = ot.select = function(t, e, i, s) {
            ...
            1 === p.length) {
                ...
                for (o = $.needsContext.test(t) ? 0 : l.length; o-- && (h = l[o],
                !n.relative[c = h.type]); )
                    if ((u = n.find[c]) && (s = u(h.matches[0].replace(Z, tt), J.test(l[0].type) && gt(e.parentNode) || e))) {
                        if (l.splice(o, 1),
                        !(t = s.length && vt(l)))
                            return P.apply(i, s),
                            i;
    ...
    y.uniqueSort = y.unique = x.uniqueSort,
    y.text = x.getText,
    y.isXMLDoc = x.isXML,
    y.contains = x.contains,
    y.escapeSelector = x.escape;
    ...
    var I = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
    function S(t, e, i) {
        return g(e) ? y.grep(t, function(t, n) {
    ...
    y.filter = function(t, e, i) {
        var n = e[0];
        return i && (t = ":not(" + t + ")"),
        1 === e.length && 1 === n.nodeType ? y.find.matchesSelector(n, t) ? [n] : [] : y.find.matches(t, y.grep(e, function(t) {
            return 1 === t.nodeType
        }))
    }
    ,
    y.fn.extend({
        ...
        is: function(t) {
            return !!S(this, "string" == typeof t && D.test(t) ? y(t) : t || [], !1).length
        }
    });
    var A, N = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (y.fn.init = function(t, e, i) {
        ...
        if (i = i || A,
        "string" == typeof t) {
            if (!(s = "<" === t[0] && ">" === t[t.length - 1] && t.length >= 3 ? [null, t, null] : N.exec(t)) || !s[1] && e)
                return !e || e.jquery ? (e || i).find(t) : this.constructor(e).find(t);
            if (s[1]) {
                if (e = e instanceof y ? e[0] : e,
                y.merge(this, y.parseHTML(s[1], e && e.nodeType ? e.ownerDocument || e : n, !0)),
                I.test(s[1]) && y.isPlainObject(e))
                    for (s in e)
                        g(this[s]) ? this[s](e[s]) : this.attr(s, e[s]);
                return this
            }
        ...
        this.length = 1,
        this) : g(t) ? void 0 !== i.ready ? i.ready(t) : t(y) : y.makeArray(t, this)
    }
    ).prototype = y.fn,
    A = y(n);
    ...
    y.fn.extend({
        ...
        closest: function(t, e) {
            var i, n = 0, s = this.length, o = [], r = "string" != typeof t && y(t);
            if (!D.test(t))
                for (; n < s; n++)
                    for (i = this[n]; i && i !== e; i = i.parentNode)
                        if (i.nodeType < 11 && (r ? r.index(i) > -1 : 1 === i.nodeType && y.find.matchesSelector(i, t))) {
                            o.push(i);
                            break
                        }
    ...
    y.each({
        ...
        y.fn[t] = function(i, n) {
            ...
            this.length > 1 && (O[t] || y.uniqueSort(s),
            P.test(t) && s.reverse()),
            this.pushStack(s)
        }
    });
    ...
    function F(t, e, i, n) {
        var s;
        try {
            t && g(s = t.promise) ? s.call(t).done(e).fail(i) : t && g(s = t.then) ? s.call(t, e, i) : e.apply(void 0, [t].slice(n))
        } catch (t) {
            i.apply(void 0, [t])
        }
    }
    y.Callbacks = function(t) {
        t = "string" == typeof t ? function(t) {
            var e = {};
            return y.each(t.match(H) || [], function(t, i) {
                e[i] = !0
            }),
            e
        }(t) : y.extend({}, t);
            ...
            add: function() {
                ...
                function e(i) {
                    y.each(i, function(i, n) {
                        g(n) ? t.unique && h.has(n) || o.push(n) : n && n.length && "string" !== b(n) && e(n)
                    })
                }(arguments),
                i && !e && l()),
                this
    ...
    y.extend({
        Deferred: function(e) {
            var i = [["notify", "progress", y.Callbacks("memory"), y.Callbacks("memory"), 2], ["resolve", "done", y.Callbacks("once memory"), y.Callbacks("once memory"), 0, "resolved"], ["reject", "fail", y.Callbacks("once memory"), y.Callbacks("once memory"), 1, "rejected"]]
              , n = "pending"
              , s = {
                state: function() {
                    return n
                    ...
                    return y.Deferred(function(e) {
                        y.each(i, function(i, n) {
                            ...
                            o[n[1]](function() {
                                ...
                                t && g(t.promise) ? t.promise().progress(e.notify).done(e.resolve).fail(e.reject) : e[n[0] + "With"](this, s ? [t] : arguments)
                            })
                        }),
                        t = null
                    }).promise()
                ...
                then: function(e, n, s) {
                            ...
                            var a = this
                              ...
                              , h = function() {
                                ...
                                if (!(e < o)) {
                                    ...
                                    g(h) ? s ? h.call(t, r(o, i, L, s), r(o, i, W, s)) : (o++,
                                    h.call(t, r(o, i, L, s), r(o, i, W, s), r(o, i, L, i.notifyWith))) : (n !== L && (a = void 0,
                                    l = [t]),
                                    (s || i.resolveWith)(a, l))
                                }
                            }
                              , c = s ? h : function() {
                                try {
                                    ...
                                    y.Deferred.exceptionHook && y.Deferred.exceptionHook(t, c.stackTrace),
                                    e + 1 >= o && (n !== W && (a = void 0,
                                    l = [t]),
                                    i.rejectWith(a, l))
                                }
                    ...
                    return y.Deferred(function(t) {
                        i[0][3].add(r(0, t, g(s) ? s : L, t.notifyWith)),
                        i[1][3].add(r(0, t, g(e) ? e : L)),
    ...
    y.extend({
        ...
        ready: function(t) {
            ...
            !0 !== t && --y.readyWait > 0 || z.resolveWith(n, [y]))
        }
    }),
    y.ready.then = z.then,
    "complete" === n.readyState || "loading" !== n.readyState && !n.documentElement.doScroll ? t.setTimeout(y.ready) : (n.addEventListener("DOMContentLoaded", j),
    ...
    function K(t) {
        return t.replace(B, "ms-").replace(Y, U)
    }
    var $ = function(t) {
    ...
    V.prototype = {
        ...
        remove: function(t, e) {
            ...
            if (void 0 !== n) {
                if (void 0 !== e) {
                    i = (e = Array.isArray(e) ? e.map(K) : (e = K(e))in n ? [e] : e.match(H) || []).length;
                    for (; i--; )
                        delete n[e[i]]
                }
        ...
        data: function(t, e) {
            ...
            if (void 0 === t) {
                ...
                1 === o.nodeType && !X.get(o, "hasDataAttrs"))) {
                    for (i = r.length; i--; )
                        r[i] && 0 === (n = r[i].name).indexOf("data-") && (n = K(n.slice(5)),
                        Z(o, n, s[n]));
            ...
            return "object" == typeof t ? this.each(function() {
                ...
                var i;
                if (o && void 0 === e)
                    return void 0 !== (i = G.get(o, t)) ? i : void 0 !== (i = Z(o, t)) ? i : void 0;
                this.each(function() {
                    G.set(this, t, e)
                })
    ...
    y.extend({
        queue: function(t, e, i) {
            ...
            if (t)
                return e = (e || "fx") + "queue",
                n = X.get(t, e),
                i && (!n || Array.isArray(i) ? n = X.access(t, e, y.makeArray(i)) : n.push(i)),
                n || []
        },
    ...
    y.fn.extend({
        queue: function(t, e) {
            ...
            t = "fx",
            i--),
            arguments.length < i ? y.queue(this[0], t) : void 0 === e ? this : this.each(function() {
        ...
        promise: function(t, e) {
            var i, n = 1, s = y.Deferred(), o = this, r = this.length, a = function() {
                --n || s.resolveWith(o, [o])
            };
            for ("string" != typeof t && (e = t,
            t = void 0),
            t = t || "fx"; r--; )
                (i = X.get(o[r], t + "queueHooks")) && i.empty && (n++,
                i.empty.add(a));
            return a(),
            s.promise(e)
        }
    ...
    function ot(t, e, i, n) {
        ...
        , l = a(), h = i && i[3] || (y.cssNumber[e] ? "" : "px"), c = (y.cssNumber[e] || "px" !== h && +l) && et.exec(y.css(t, e));
        if (c && c[3] !== h) {
            for (l /= 2,
            h = h || c[3],
            c = +l || 1; r--; )
    ...
    var rt = {};
    function at(t) {
        var e, i = t.ownerDocument, n = t.nodeName, s = rt[n];
    ...
    function lt(t, e) {
        for (var i, n, s = [], o = 0, r = t.length; o < r; o++)
            ...
            e ? ("none" === i && (s[o] = X.get(n, "display") || null,
            s[o] || (n.style.display = "")),
            "" === n.style.display && nt(n) && (s[o] = at(n))) : "none" !== i && (s[o] = "none",
            X.set(n, "display", i)));
        for (o = 0; o < r; o++)
    ...
    function pt(t, e) {
        ...
        void 0 === e || e && E(t, e) ? y.merge([t], i) : i
    }
    function ft(t, e) {
        for (var i = 0, n = t.length; i < n; i++)
        ...
        for (var o, r, a, l, h, c, u = e.createDocumentFragment(), d = [], p = 0, f = t.length; p < f; p++)
            if ((o = t[p]) || 0 === o)
                if ("object" === b(o))
                    ...
                    c = l[0]; c--; )
                        r = r.lastChild;
                    y.merge(d, r.childNodes),
                    (r = u.firstChild).textContent = ""
                } else
                    d.push(e.createTextNode(o));
        for (u.textContent = "",
        p = 0; o = d[p++]; )
            if (n && y.inArray(o, n) > -1)
                s && s.push(o);
            else if (h = y.contains(o.ownerDocument, o),
    ...
    gt = n.createDocumentFragment().appendChild(n.createElement("div")),
    (mt = n.createElement("input")).setAttribute("type", "radio"),
    mt.setAttribute("checked", "checked"),
    mt.setAttribute("name", "t"),
    gt.appendChild(mt),
    f.checkClone = gt.cloneNode(!0).cloneNode(!0).lastChild.checked,
    gt.innerHTML = "<textarea>x</textarea>",
    f.noCloneChecked = !!gt.cloneNode(!0).lastChild.defaultValue;
    var bt = n.documentElement
      , yt = /^key/
    ...
    y.event = {
        ...
        add: function(t, e, i, n, s) {
            var o, r, a, l, h, c, u, d, p, f, g, m = X.get(t);
            if (m)
                for (i.handler && (i = (o = i).handler,
                s = o.selector),
                s && y.find.matchesSelector(bt, s),
            ...
            if (m && (l = m.events)) {
                for (h = (e = (e || "").match(H) || [""]).length; h--; )
                    ...
                    p) {
                        ...
                        r && !d.length && (u.teardown && !1 !== u.teardown.call(t, f, m.handle) || y.removeEvent(t, p, m.handle),
                        delete l[p])
                    } else
                        for (p in l)
                            y.event.remove(t, p + e[h], i, n, !0);
                y.isEmptyObject(l) && X.remove(t, "handle events")
            }
        },
        dispatch: function(t) {
            var e, i, n, s, o, r, a = y.event.fix(t), l = new Array(arguments.length), h = (X.get(this, "events") || {})[a.type] || [], c = y.event.special[a.type] || {};
            for (l[0] = a,
            e = 1; e < arguments.length; e++)
                l[e] = arguments[e];
            if (a.delegateTarget = this,
            !c.preDispatch || !1 !== c.preDispatch.call(this, a)) {
                for (r = y.event.handlers.call(this, a, h),
                e = 0; (s = r[e++]) && !a.isPropagationStopped(); )
                    ...
                    i = 0; (o = s.handlers[i++]) && !a.isImmediatePropagationStopped(); )
                        ...
                        a.data = o.data,
                        void 0 !== (n = ((y.event.special[o.origType] || {}).handle || o.handler).apply(s.elem, l)) && !1 === (a.result = n) && (a.preventDefault(),
                        a.stopPropagation()));
            ...
            if (l && h.nodeType && !("click" === t.type && t.button >= 1))
                for (; h !== this; h = h.parentNode || this)
                    if (1 === h.nodeType && ("click" !== t.type || !0 !== h.disabled)) {
                        ...
                        r = {},
                        i = 0; i < l; i++)
                            void 0 === r[s = (n = e[i]).selector + " "] && (r[s] = n.needsContext ? y(s, this).index(h) > -1 : y.find(s, this, null, [h]).length),
                            r[s] && o.push(n);
                        o.length && a.push({
                            elem: h,
                            handlers: o
    ...
    y.each({
        ...
        y.event.special[t] = {
            ...
            handle: function(t) {
                ...
                return n && (n === this || y.contains(this, n)) || (t.type = s.origType,
    ...
    var Et = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi
      ...
      , At = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    function Nt(t, e) {
        return E(t, "table") && E(11 !== e.nodeType ? e : e.firstChild, "tr") && y(t).children("tbody")[0] || t
    }
    function Pt(t) {
    ...
    function Ht(t, e, i, n) {
        e = r.apply([], e);
        var s, o, a, l, h, c, u = 0, d = t.length, p = d - 1, m = e[0], v = g(m);
        ...
        if (d && (o = (s = _t(e, t[0].ownerDocument, !1, t, n)).firstChild,
        1 === s.childNodes.length && (s = o),
        o || n)) {
            for (l = (a = y.map(pt(s, "script"), Pt)).length; u < d; u++)
                h = s,
                u !== p && (h = y.clone(h, !0, !0),
                l && y.merge(a, pt(h, "script"))),
                i.call(t[u], h, u);
            if (l)
                ...
                u = 0; u < l; u++)
                    h = a[u],
                    ut.test(h.type || "") && !X.access(h, "globalEval") && y.contains(c, h) && (h.src && "module" !== (h.type || "").toLowerCase() ? y._evalUrl && y._evalUrl(h.src) : _(h.textContent.replace(At, ""), c, h))
        }
        return t
    }
    function Lt(t, e, i) {
        for (var n, s = e ? y.filter(e, t) : t, o = 0; null != (n = s[o]); o++)
            ...
            n.parentNode && (i && y.contains(n.ownerDocument, n) && ft(pt(n, "script")),
    ...
    y.extend({
        ...
        clone: function(t, e, i) {
            var n, s, o, r, a, l, h, c = t.cloneNode(!0), u = y.contains(t.ownerDocument, t);
            if (!(f.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || y.isXMLDoc(t)))
                for (r = pt(c),
                n = 0,
                s = (o = pt(t)).length; n < s; n++)
                    a = o[n],
                    l = r[n],
                    h = void 0,
                    "input" === (h = l.nodeName.toLowerCase()) && ht.test(a.type) ? l.checked = a.checked : "input" !== h && "textarea" !== h || (l.defaultValue = a.defaultValue);
            if (e)
                if (i)
                    for (o = o || pt(t),
                    r = r || pt(c),
                    ...
                    Mt(t, c);
            return (r = pt(c, "script")).length > 0 && ft(r, !u && pt(t, "script")),
            c
        },
    ...
    y.fn.extend({
        ...
        empty: function() {
            for (var t, e = 0; null != (t = this[e]); e++)
                1 === t.nodeType && (y.cleanData(pt(t, !1)),
                t.textContent = "");
            return this
        },
        clone: function(t, e) {
        ...
        html: function(t) {
            return q(this, function(t) {
                ...
                if ("string" == typeof t && !It.test(t) && !dt[(ct.exec(t) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; i < n; i++)
                            1 === (e = this[i] || {}).nodeType && (y.cleanData(pt(e, !1)),
                            e.innerHTML = t);
                        e = 0
                    } catch (t) {}
                }
        ...
        replaceWith: function() {
            ...
            return Ht(this, arguments, function(e) {
                ...
                y.inArray(this, t) < 0 && (y.cleanData(pt(this)),
    ...
    y.each({
        ...
        y.fn[t] = function(t) {
            for (var i, n = [], s = y(t), o = s.length - 1, r = 0; r <= o; r++)
    ...
    function zt(t, e, i) {
        ...
        return (i = i || Ft(t)) && ("" !== (r = i.getPropertyValue(e) || i[e]) || y.contains(t.ownerDocument, t) || (r = y.style(t, e)),
        !f.pixelBoxStyles() && Wt.test(r) && Rt.test(e) && (n = a.width,
        s = a.minWidth,
        o = a.maxWidth,
    ...
    !function() {
        function e() {
            if (c) {
                ...
                bt.appendChild(h).appendChild(c);
        ...
        var s, o, r, a, l, h = n.createElement("div"), c = n.createElement("div");
    ...
    function Gt(t, e, i, n, s, o) {
        ...
        for (; r < 4; r += 2)
            ...
            n ? ("content" === i && (l -= y.css(t, "padding" + it[r], !0, s)),
            "margin" !== i && (l -= y.css(t, "border" + it[r] + "Width", !0, s))) : (l += y.css(t, "padding" + it[r], !0, s),
            "padding" !== i ? l += y.css(t, "border" + it[r] + "Width", !0, s) : a += y.css(t, "border" + it[r] + "Width", !0, s));
    ...
    function Qt(t, e, i) {
        ...
        return r = r && (f.boxSizingReliable() || s === t.style[e]),
        ("auto" === s || !parseFloat(s) && "inline" === y.css(t, "display", !1, n)) && (s = t["offset" + e[0].toUpperCase() + e.slice(1)],
        r = !0),
        (s = parseFloat(s) || 0) + Gt(t, e, i || (o ? "border" : "content"), r, n, s) + "px"
    }
    ...
    y.extend({
        ...
        style: function(t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var s, o, r, a = K(e), l = Bt.test(e), h = t.style;
                if (l || (e = Vt(a)),
                r = y.cssHooks[e] || y.cssHooks[a],
                void 0 === i)
                    return r && "get"in r && void 0 !== (s = r.get(t, !1, n)) ? s : h[e];
                "string" === (o = typeof i) && (s = et.exec(i)) && s[1] && (i = ot(t, e, s),
                o = "number"),
                null != i && i == i && ("number" === o && (i += s && s[3] || (y.cssNumber[a] ? "" : "px")),
                f.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (h[e] = "inherit"),
                r && "set"in r && void 0 === (i = r.set(t, i, n)) || (l ? h.setProperty(e, i) : h[e] = i))
            }
        },
        css: function(t, e, i, n) {
            var s, o, r, a = K(e);
            return Bt.test(e) || (e = Vt(a)),
    ...
    y.each(["height", "width"], function(t, e) {
        y.cssHooks[e] = {
            get: function(t, i, n) {
                if (i)
                    return !qt.test(y.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? Qt(t, e, n) : st(t, Yt, function() {
                        return Qt(t, e, n)
                    })
            },
            set: function(t, i, n) {
                var s, o = Ft(t), r = "border-box" === y.css(t, "boxSizing", !1, o), a = n && Gt(t, e, n, r, o);
                return r && f.scrollboxSize() === o.position && (a -= Math.ceil(t["offset" + e[0].toUpperCase() + e.slice(1)] - parseFloat(o[e]) - Gt(t, e, "border", !1, o) - .5)),
                a && (s = et.exec(i)) && "px" !== (s[3] || "px") && (t.style[e] = i,
                i = y.css(t, e)),
                Xt(0, i, a)
            }
        }
    }),
    y.cssHooks.marginLeft = jt(f.reliableMarginLeft, function(t, e) {
        if (e)
            return (parseFloat(zt(t, "marginLeft")) || t.getBoundingClientRect().left - st(t, {
                marginLeft: 0
            }, function() {
    ...
    y.each({
        ...
        "margin" !== t && (y.cssHooks[t + e].set = Xt)
    }),
    y.fn.extend({
        css: function(t, e) {
    ...
    Jt.prototype = {
        ...
        run: function(t) {
            ...
            return this.options.duration ? this.pos = e = y.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : this.pos = e = t,
    ...
    y.fx = Jt.prototype.init,
    y.fx.step = {};
    var Zt, te, ee = /^(?:toggle|show|hide)$/, ie = /queueHooks$/;
    function ne() {
        te && (!1 === n.hidden && t.requestAnimationFrame ? t.requestAnimationFrame(ne) : t.setTimeout(ne, y.fx.interval),
        y.fx.tick())
    }
    function se() {
    ...
    function re(t, e, i) {
        for (var n, s = (ae.tweeners[e] || []).concat(ae.tweeners["*"]), o = 0, r = s.length; o < r; o++)
            if (n = s[o].call(i, e, t))
                return n
    }
    function ae(t, e, i) {
        var n, s, o = 0, r = ae.prefilters.length, a = y.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (s)
                return !1;
            for (var e = Zt || se(), i = Math.max(0, h.startTime + h.duration - e), n = 1 - (i / h.duration || 0), o = 0, r = h.tweens.length; o < r; o++)
                h.tweens[o].run(n);
        ...
        for (!function(t, e) {
            ...
            if (n = ae.prefilters[o].call(h, t, c, h.opts))
                return g(n.stop) && (y._queueHooks(h.elem, h.opts.queue).stop = n.stop.bind(n)),
                n;
        return y.map(c, re, h),
    ...
    y.Animation = y.extend(ae, {
        ...
        prefilters: [function(t, e, i) {
            var n, s, o, r, a, l, h, c, u = "width"in e || "height"in e, d = this, p = {}, f = t.style, g = t.nodeType && nt(t), m = X.get(t, "fxshow");
            for (n in i.queue || (null == (r = y._queueHooks(t, "fx")).unqueued && (r.unqueued = 0,
            a = r.empty.fire,
            ...
            d.always(function() {
                d.always(function() {
                    r.unqueued--,
                    y.queue(t, "fx").length || r.empty.fire()
                })
            })),
            e)
                if (s = e[n],
            ...
            if ((l = !y.isEmptyObject(e)) || !y.isEmptyObject(p))
                ...
                "none" === (c = y.css(t, "display")) && (h ? c = h : (lt([t], !0),
                h = t.style.display || h,
                c = y.css(t, "display"),
                lt([t]))),
                ("inline" === c || "inline-block" === c && null != h) && "none" === y.css(t, "float") && (l || (d.done(function() {
                    f.display = h
                }),
                null == h && (c = f.display,
                h = "none" === c ? "" : c)),
    ...
    y.speed = function(t, e, i) {
        var n = t && "object" == typeof t ? y.extend({}, t) : {
    ...
    y.fn.extend({
        ...
        finish: function(t) {
            return !1 !== t && (t = t || "fx"),
            this.each(function() {
                var e, i = X.get(this), n = i[t + "queue"], s = i[t + "queueHooks"], o = y.timers, r = n ? n.length : 0;
                for (i.finish = !0,
                y.queue(this, t, []),
    ...
    y.each(["toggle", "show", "hide"], function(t, e) {
        ...
        y.fn[e] = function(t, n, s) {
            return null == t || "boolean" == typeof t ? i.apply(this, arguments) : this.animate(oe(e, !0), t, n, s)
        }
    }),
    y.each({
        slideDown: oe("show"),
    ...
    y.extend({
        attr: function(t, e, i) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === t.getAttribute ? y.prop(t, e, i) : (1 === o && y.isXMLDoc(t) || (s = y.attrHooks[e.toLowerCase()] || (y.expr.match.bool.test(e) ? le : void 0)),
                void 0 !== i ? null === i ? void y.removeAttr(t, e) : s && "set"in s && void 0 !== (n = s.set(t, i, e)) ? n : (t.setAttribute(e, i + ""),
                i) : s && "get"in s && null !== (n = s.get(t, e)) ? n : null == (n = y.find.attr(t, e)) ? void 0 : n)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
    ...
    le = {
        set: function(t, e, i) {
            return !1 === e ? y.removeAttr(t, i) : t.setAttribute(i, i),
            i
        }
    },
    y.each(y.expr.match.bool.source.match(/\w+/g), function(t, e) {
        var i = he[e] || y.find.attr;
        he[e] = function(t, e, n) {
    ...
    y.fn.extend({
        addClass: function(t) {
            ...
            if (g(t))
                return this.each(function(e) {
                    y(this).addClass(t.call(this, e, pe(this)))
                });
            if ((e = fe(t)).length)
                for (; i = this[l++]; )
                    if (s = pe(i),
        ...
        removeClass: function(t) {
            ...
            if (g(t))
                return this.each(function(e) {
                    y(this).removeClass(t.call(this, e, pe(this)))
                });
            if (!arguments.length)
        ...
        toggleClass: function(t, e) {
            ...
            return "boolean" == typeof e && n ? e ? this.addClass(t) : this.removeClass(t) : g(t) ? this.each(function(i) {
                y(this).toggleClass(t.call(this, i, pe(this), e), e)
            }) : this.each(function() {
                var e, s, o, r;
                if (n)
                    for (s = 0,
                    ...
                    void 0 !== t && "boolean" !== i || ((e = pe(this)) && X.set(this, "__className__", e),
        ...
        hasClass: function(t) {
            var e, i, n = 0;
            for (e = " " + t + " "; i = this[n++]; )
                if (1 === i.nodeType && (" " + de(pe(i)) + " ").indexOf(e) > -1)
                    return !0;
            return !1
        }
    });
    ...
    y.fn.extend({
        val: function(t) {
            ...
            this.each(function(i) {
                var s;
                1 === this.nodeType && (null == (s = n ? t.call(this, i, y(this).val()) : t) ? s = "" : "number" == typeof s ? s += "" : Array.isArray(s) && (s = y.map(s, function(t) {
                    return null == t ? "" : t + ""
                })),
                (e = y.valHooks[this.type] || y.valHooks[this.nodeName.toLowerCase()]) && "set"in e && void 0 !== e.set(this, s, "value") || (this.value = s))
            })) : s ? (e = y.valHooks[s.type] || y.valHooks[s.nodeName.toLowerCase()]) && "get"in e && void 0 !== (i = e.get(s, "value")) ? i : "string" == typeof (i = s.value) ? i.replace(ge, "") : null == i ? "" : i : void 0
        }
    }),
    y.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function(t, e) {
                    for (var i, n, s = t.options, o = y.makeArray(e), r = s.length; r--; )
                        ((n = s[r]).selected = y.inArray(y.valHooks.option.get(n), o) > -1) && (i = !0);
    ...
    y.extend(y.event, {
        trigger: function(e, i, s, o) {
            var r, a, l, h, c, d, p, f, v = [s || n], _ = u.call(e, "type") ? e.type : e, b = u.call(e, "namespace") ? e.namespace.split(".") : [];
            if (a = f = l = s = s || n,
            3 !== s.nodeType && 8 !== s.nodeType && !me.test(_ + y.event.triggered) && (_.indexOf(".") > -1 && (b = _.split("."),
            _ = b.shift(),
            b.sort()),
            c = _.indexOf(":") < 0 && "on" + _,
            (e = e[y.expando] ? e : new y.Event(_,"object" == typeof e && e)).isTrigger = o ? 2 : 3,
            e.namespace = b.join("."),
            ...
            o || !p.trigger || !1 !== p.trigger.apply(s, i))) {
                if (!o && !p.noBubble && !m(s)) {
                    for (h = p.delegateType || _,
                    me.test(h + _) || (a = a.parentNode); a; a = a.parentNode)
                        v.push(a),
                        l = a;
                    l === (s.ownerDocument || n) && v.push(l.defaultView || l.parentWindow || t)
                }
                for (r = 0; (a = v[r++]) && !e.isPropagationStopped(); )
                    f = a,
                    e.type = r > 1 ? h : p.bindType || _,
                    (d = (X.get(a, "events") || {})[e.type] && X.get(a, "handle")) && d.apply(a, i),
                    (d = c && a[c]) && d.apply && $(a) && (e.result = d.apply(a, i),
                    !1 === e.result && e.preventDefault());
                return e.type = _,
                o || e.isDefaultPrevented() || p._default && !1 !== p._default.apply(v.pop(), i) || !$(s) || c && g(s[_]) && !m(s) && ((l = s[c]) && (s[c] = null),
                y.event.triggered = _,
                e.isPropagationStopped() && f.addEventListener(_, ve),
                s[_](),
                e.isPropagationStopped() && f.removeEventListener(_, ve),
    ...
    y.fn.extend({
        ...
        triggerHandler: function(t, e) {
            var i = this[0];
            if (i)
                return y.event.trigger(t, e, i, !0)
        }
    }),
    f.focusin || y.each({
        focus: "focusin",
        ...
        y.event.special[e] = {
            ...
            teardown: function() {
                var n = this.ownerDocument || this
                  , s = X.access(n, e) - 1;
                s ? X.access(n, e, s) : (n.removeEventListener(t, i, !0),
                X.remove(n, e))
            }
        }
    });
    ...
    y.parseXML = function(e) {
        ...
        return i && !i.getElementsByTagName("parsererror").length || y.error("Invalid XML: " + e),
        i
    }
    ;
    var we = /\[\]$/
    ...
    function ke(t, e, i, n) {
        ...
        if (Array.isArray(e))
            y.each(e, function(e, s) {
                i || we.test(t) ? n(t, s) : ke(t + "[" + ("object" == typeof s && null != s ? e : "") + "]", s, i, n)
            });
    ...
    y.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !y(this).is(":disabled") && Te.test(this.nodeName) && !xe.test(t) && (this.checked || !ht.test(t))
            }).map(function(t, e) {
                var i = y(this).val();
    ...
    function Fe(t, e) {
        var i, n, s = y.ajaxSettings.flatOptions || {};
        for (i in e)
            void 0 !== e[i] && ((s[i] ? t : n || (n = {}))[i] = e[i]);
        return n && y.extend(!0, t, n),
        t
    }
    He.href = _e.href,
    y.extend({
        ...
        ajaxSetup: function(t, e) {
            return e ? Fe(Fe(t, y.ajaxSettings), e) : Fe(y.ajaxSettings, t)
        },
        ajaxPrefilter: Le(Pe),
        ajaxTransport: Le(Oe),
        ajax: function(e, i) {
            ...
            e = void 0),
            i = i || {};
            var s, o, r, a, l, h, c, u, d, p, f = y.ajaxSetup({}, i), g = f.context || f, m = f.context && (g.nodeType || g.jquery) ? y(g) : y.event, v = y.Deferred(), _ = y.Callbacks("once memory"), b = f.statusCode || {}, w = {}, C = {}, x = "canceled", T = {
                readyState: 0,
                ...
                setRequestHeader: function(t, e) {
                    return null == c && (t = C[t.toLowerCase()] = C[t.toLowerCase()] || t,
                    w[t] = e),
                    this
                },
            ...
            null == f.crossDomain) {
                ...
                try {
                    h.href = f.url,
                    h.href = h.href,
                    f.crossDomain = He.protocol + "//" + He.host != h.protocol + "//" + h.host
                } catch (t) {
                    f.crossDomain = !0
                }
            }
            ...
            f.data && (f.processData || "string" == typeof f.data) && (o += (ye.test(o) ? "&" : "?") + f.data,
            delete f.data),
            !1 === f.cache && (o = o.replace(Ie, "$1"),
            p = (ye.test(o) ? "&" : "?") + "_=" + be++ + p),
            f.url = o + p),
            f.ifModified && (y.lastModified[o] && T.setRequestHeader("If-Modified-Since", y.lastModified[o]),
            y.etag[o] && T.setRequestHeader("If-None-Match", y.etag[o])),
            ...
            function k(e, i, n, a) {
                ...
                h ? (f.ifModified && ((C = T.getResponseHeader("Last-Modified")) && (y.lastModified[o] = C),
                (C = T.getResponseHeader("etag")) && (y.etag[o] = C)),
                ...
                T.status = e,
                T.statusText = (i || x) + "",
                h ? v.resolveWith(g, [d, x, T]) : v.rejectWith(g, [T, x, p]),
                T.statusCode(b),
                b = void 0,
                u && m.trigger(h ? "ajaxSuccess" : "ajaxError", [T, f, h ? d : p]),
                _.fireWith(g, [T, x]),
    ...
    y.ajaxSetup({
        ...
        jsonpCallback: function() {
            var t = qe.pop() || y.expando + "_" + be++;
            return this[t] = !0,
            t
        }
    }),
    y.ajaxPrefilter("json jsonp", function(e, i, n) {
        var s, o, r, a = !1 !== e.jsonp && (Be.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && Be.test(e.data) && "data");
        if (a || "jsonp" === e.dataTypes[0])
            return s = e.jsonpCallback = g(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
            a ? e[a] = e[a].replace(Be, "$1" + s) : !1 !== e.jsonp && (e.url += (ye.test(e.url) ? "&" : "?") + e.jsonp + "=" + s),
            e.converters["script json"] = function() {
                return r || y.error(s + " was not called"),
                r[0]
            }
            ,
            e.dataTypes[0] = "json",
    ...
    f.createHTMLDocument = ((je = n.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    ...
    y.parseHTML = function(t, e, i) {
        ...
        r = !i && [],
        (o = I.exec(t)) ? [e.createElement(o[1])] : (o = _t([t], e, r),
    ...
    y.offset = {
        setOffset: function(t, e, i) {
            var n, s, o, r, a, l, h = y.css(t, "position"), c = y(t), u = {};
            "static" === h && (t.style.position = "relative"),
            a = c.offset(),
            o = y.css(t, "top"),
            l = y.css(t, "left"),
            ("absolute" === h || "fixed" === h) && (o + l).indexOf("auto") > -1 ? (r = (n = c.position()).top,
        ...
        position: function() {
            if (this[0]) {
                ...
                if ("fixed" === y.css(n, "position"))
                    ...
                    for (e = this.offset(),
                    i = n.ownerDocument,
                    t = n.offsetParent || i.documentElement; t && (t === i.body || t === i.documentElement) && "static" === y.css(t, "position"); )
                        t = t.parentNode;
                    t && t !== n && 1 === t.nodeType && ((s = y(t).offset()).top += y.css(t, "borderTopWidth", !0),
    ...
    y.each({
        ...
        y.fn[t] = function(n) {
            return q(this, function(t, n, s) {
                var o;
                if (m(t) ? o = t : 9 === t.nodeType && (o = t.defaultView),
                void 0 === s)
                    return o ? o[e] : t[n];
    ...
    y.each(["top", "left"], function(t, e) {
        y.cssHooks[e] = jt(f.pixelPosition, function(t, i) {
            if (i)
                return i = zt(t, e),
                Wt.test(i) ? y(t).position()[e] + "px" : i
        })
    }),
    y.each({
        Height: "height",
        ...
        y.each({
            ...
            y.fn[n] = function(s, o) {
                ...
                return q(this, function(e, i, s) {
                    var o;
                    return m(e) ? 0 === n.indexOf("outer") ? e["inner" + t] : e.document.documentElement["client" + t] : 9 === e.nodeType ? (o = e.documentElement,
                    Math.max(e.body["scroll" + t], o["scroll" + t], e.body["offset" + t], o["offset" + t], o["client" + t])) : void 0 === s ? y.css(e, i, a) : y.style(e, i, s, a)
                }, e, r ? s : void 0, r)
            }
        })
    }),
...
function(t, e) {
    ...
    "use strict";
    for (var t = "undefined" != typeof window && "undefined" != typeof document, e = ["Edge", "Trident", "Firefox"], i = 0, n = 0; n < e.length; n += 1)
        if (t && navigator.userAgent.indexOf(e[n]) >= 0) {
            i = 1;
            break
        }
    ...
    var h = t && !(!window.MSInputMethodContext || !document.documentMode)
      , c = t && /MSIE 10/.test(navigator.userAgent);
    function u(t) {
        return 11 === t ? h : 10 === t ? c : h || c
    }
    function d(t) {
        if (!t)
            return document.documentElement;
        for (var e = u(10) ? document.body : null, i = t.offsetParent || null; i === e && t.nextElementSibling; )
            i = (t = t.nextElementSibling).offsetParent;
        var n = i && i.nodeName;
        return n && "BODY" !== n && "HTML" !== n ? -1 !== ["TH", "TD", "TABLE"].indexOf(i.nodeName) && "static" === r(i, "position") ? d(i) : i : t ? t.ownerDocument.documentElement : document.documentElement
    }
    function p(t) {
    ...
    function f(t, e) {
        ...
        if (t !== l && e !== l || n.contains(s))
            return "BODY" === (a = (r = l).nodeName) || "HTML" !== a && d(r.firstElementChild) !== r ? d(l) : l;
        var h = p(t);
        return h.host ? f(h.host, e) : f(t, p(e).host)
    }
    function g(t) {
    ...
    function k(t, e) {
        ...
        return (n && !i ? e.contains(h) : e === h && "BODY" !== h.nodeName) && (f = function(t, e) {
            var i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2]
              , n = g(e, "top")
              , s = g(e, "left")
              , o = i ? -1 : 1;
    ...
    function M(t, e, i) {
        return (void 0 === i ? t : t.slice(0, function(t, e, i) {
            ...
            t.enabled && o(i) && (e.offsets.popper = x(e.offsets.popper),
    ...
    function j(t, e) {
        Object.keys(e).forEach(function(i) {
            var n = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(i) && z(e[i]) && (n = "px"),
            t.style[i] = e[i] + n
        })
    }
        ...
        modifiers: {
            ...
            preventOverflow: {
                ...
                fn: function(t, e) {
                    ...
                    s.left = "",
                    s[n] = "";
                    var l = E(t.instance.popper, t.instance.reference, e.padding, i, t.positionFixed);
                    s.top = o,
                    s.left = r,
                    s[n] = a,
                    e.boundaries = l;
            ...
            arrow: {
                ...
                fn: function(t, e) {
                    ...
                    var m = l[d] + l[c] / 2 - g / 2
                      ...
                      , y = m - t.offsets.popper[d] - _ - b;
                    return y = Math.max(Math.min(a[c] - g, y), 0),
                    t.arrowElement = n,
                    t.offsets.arrow = (w(i = {}, d, Math.round(y)),
                    w(i, p, ""),
                    i),
                    t
                },
            ...
            flip: {
                ...
                fn: function(t, e) {
                    ...
                    if (t.flipped && t.placement === t.originalPlacement)
                        return t;
                    var i = E(t.instance.popper, t.instance.reference, e.padding, e.boundariesElement, t.positionFixed)
                    ...
                    return r.forEach(function(a, l) {
                        ...
                        var h = t.offsets.popper
                          ...
                          , b = !!e.flipVariations && (_ && "start" === o && p || _ && "end" === o && f || !_ && "start" === o && g || !_ && "end" === o && m);
                        (d || v || b) && (t.flipped = !0,
                        (d || v) && (n = r[l + 1]),
                        b && (o = function(t) {
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    var r = void 0 !== o ? o : e.gpuAcceleration
                      ...
                      , g = void 0
                      , m = void 0;
                    if (m = "bottom" === u ? "HTML" === a.nodeName ? -a.clientHeight + c.bottom : -l.height + c.bottom : c.top,
                    g = "right" === p ? "HTML" === a.nodeName ? -a.clientWidth + c.right : -l.width + c.right : c.left,
                    r && f)
                        h[f] = "translate3d(" + g + "px, " + m + "px, 0)",
                        h[u] = 0,
                        h[p] = 0,
            ...
            applyStyle: {
                ...
                onLoad: function(t, e, i, n, s) {
                    var o = S(s, e, t, i.positionFixed)
                      , r = I(i.placement, o, e, t, i.modifiers.flip.boundariesElement, i.modifiers.flip.padding);
...
function(t, e) {
    ...
    var c = e.fn.alert
      ...
      , g = function() {
        ...
        i._removeElement = function(t) {
            var i = this;
            if (e(t).removeClass(f),
            e(t).hasClass(p)) {
                var n = h.getTransitionDurationFromElement(t);
      ...
      , D = function() {
        ...
        return i.toggle = function() {
            ...
            if (n) {
                ...
                if (s) {
                    if ("radio" === s.type)
                        if (s.checked && this._element.classList.contains(v))
                            t = !1;
                        else {
                    ...
                    if (t) {
                        if (s.hasAttribute("disabled") || n.hasAttribute("disabled") || s.classList.contains("disabled") || n.classList.contains("disabled"))
                            return;
                        s.checked = !this._element.classList.contains(v),
                        e(s).trigger("change")
                    }
                    s.focus(),
                    i = !1
            ...
            i && this._element.setAttribute("aria-pressed", !this._element.classList.contains(v)),
    ...
    e(document).on(k.CLICK_DATA_API, y, function(t) {
        t.preventDefault();
        var i = t.target;
        e(i).hasClass(_) || (i = e(i).closest(T)),
        D._jQueryInterface.call(e(i), "toggle")
    }).on(k.FOCUS_BLUR_DATA_API, y, function(t) {
        var i = e(t.target).closest(T)[0];
        e(i).toggleClass(b, /^focus(in)?$/.test(t.type))
    }),
    ...
    var E = "carousel"
      ...
      , $ = function() {
        ...
        i.pause = function(t) {
            t || (this._isPaused = !0),
            this._element.querySelector(U.NEXT_PREV) && (h.triggerTransitionEnd(this._element),
            this.cycle(!0)),
        ...
        i._addTouchEventListeners = function() {
            ...
            if (this._touchSupported) {
                ...
                e(this._element.querySelectorAll(U.ITEM_IMG)).on(L.DRAG_START, function(t) {
                ...
                this._element.classList.add(Y)) : (e(this._element).on(L.TOUCHSTART, function(t) {
                    return i(t)
                }),
        ...
        i._getItemIndex = function(t) {
            return this._items = t && t.parentNode ? [].slice.call(t.parentNode.querySelectorAll(U.ITEM)) : [],
        ...
        i._getItemByDirection = function(t, e) {
            ...
            if ((n && 0 === s || i && s === o) && !this._config.wrap)
                return e;
            var r = (s + (t === O ? -1 : 1)) % this._items.length;
            return -1 === r ? this._items[this._items.length - 1] : this._items[r]
        }
        ,
        i._triggerSlideEvent = function(t, i) {
            var n = this._getItemIndex(t)
              , s = this._getItemIndex(this._element.querySelector(U.ACTIVE_ITEM))
              , o = e.Event(L.SLIDE, {
                relatedTarget: t,
                direction: i,
                from: s,
        ...
        i._slide = function(t, i) {
            var n, s, o, r = this, a = this._element.querySelector(U.ACTIVE_ITEM), l = this._getItemIndex(a), c = i || a && this._getItemByDirection(t, a), u = this._getItemIndex(c), d = Boolean(this._interval);
            if (t === P ? (n = j,
            s = q,
            o = M) : (n = z,
            s = B,
            ...
            c && e(c).hasClass(F))
                ...
                if (e(this._element).hasClass(R)) {
                    ...
                    var g = h.getTransitionDurationFromElement(a);
                    e(a).one(h.TRANSITION_END, function() {
                        e(c).removeClass(n + " " + s).addClass(F),
                        e(a).removeClass(F + " " + s + " " + n),
                        r._isSliding = !1,
                        setTimeout(function() {
    ...
    e(document).on(L.CLICK_DATA_API, U.DATA_SLIDE, $._dataApiClickHandler),
    ...
    var V = "collapse"
      ...
      , rt = function() {
        function t(t, e) {
            ...
            for (var i = [].slice.call(document.querySelectorAll(ot.DATA_TOGGLE)), n = 0, s = i.length; n < s; n++) {
                var o = i[n]
        ...
        i.show = function() {
            var i, n, s = this;
            if (!this._isTransitioning && !e(this._element).hasClass(Z) && (this._parent && 0 === (i = [].slice.call(this._parent.querySelectorAll(ot.ACTIVES)).filter(function(t) {
                return "string" == typeof s._config.parent ? t.getAttribute("data-parent") === s._config.parent : t.classList.contains(tt)
            })).length && (i = null),
            !(i && (n = e(i).not(this._selector).data("bs.collapse")) && n._isTransitioning))) {
                ...
                !o.isDefaultPrevented()) {
                    ...
                    e(this._element).one(h.TRANSITION_END, function() {
                        e(s._element).removeClass(et).addClass(tt).addClass(Z),
                        s._element.style[r] = "",
                        s.setTransitioning(!1),
                        e(s._element).trigger(J.SHOWN)
                ...
                !i.isDefaultPrevented()) {
                    ...
                    if (s > 0)
                        for (var o = 0; o < s; o++) {
                            ...
                            if (null !== a)
                                e([].slice.call(document.querySelectorAll(a))).hasClass(Z) || e(r).addClass(it).attr("aria-expanded", !1)
                        }
                    this.setTransitioning(!0);
        ...
        ,
        i._getConfig = function(t) {
            return (t = r({}, G, t)).toggle = Boolean(t.toggle),
            h.typeCheckConfig(V, t, Q),
            t
        }
        ,
        i._getDimension = function() {
            return e(this._element).hasClass(nt) ? nt : st
        }
        ,
        ...
        t._jQueryInterface = function(i) {
            return this.each(function() {
                var n = e(this)
                  ...
                  , o = r({}, G, n.data(), "object" == typeof i && i ? i : {});
    ...
    e.fn[V] = rt._jQueryInterface,
    e.fn[V].Constructor = rt,
      ...
      , Nt = function() {
                ...
                !s) {
                    ...
                    !r.isDefaultPrevented()) {
                        if (!this._inNavbar) {
                            ...
                            var a = this._element;
                            "parent" === this._config.reference ? a = n : h.isElement(this._config.reference) && (a = this._config.reference,
                        ...
                        e(n).toggleClass(dt).trigger(e.Event(ct.SHOWN, o))
                    }
                }
            }
        }
        ...
        n.show = function() {
            if (!(this._element.disabled || e(this._element).hasClass(ut) || e(this._menu).hasClass(dt))) {
                ...
                e(s).trigger(n),
                n.isDefaultPrevented() || (e(this._menu).toggleClass(dt),
                e(s).toggleClass(dt).trigger(e.Event(ct.SHOWN, i)))
            }
        }
        ,
        n.hide = function() {
            if (!this._element.disabled && !e(this._element).hasClass(ut) && e(this._menu).hasClass(dt)) {
                ...
                e(s).trigger(n),
                n.isDefaultPrevented() || (e(this._menu).toggleClass(dt),
                e(s).toggleClass(dt).trigger(e.Event(ct.HIDDEN, i)))
            }
        }
        ,
        n.dispose = function() {
        ...
        n._getConfig = function(t) {
            ...
            h.typeCheckConfig(at, t, this.constructor.DefaultType),
            t
        }
        ,
        ...
        n._getPlacement = function() {
            var t = e(this._element.parentNode)
              , i = kt;
            return t.hasClass(pt) ? (i = xt,
            e(this._menu).hasClass(mt) && (i = Tt)) : t.hasClass(ft) ? i = Et : t.hasClass(gt) ? i = It : e(this._menu).hasClass(mt) && (i = Dt),
            i
        }
        ,
        ...
        t._clearMenus = function(i) {
            if (!i || 3 !== i.which && ("keyup" !== i.type || 9 === i.which))
                for (var n = [].slice.call(document.querySelectorAll(_t)), s = 0, o = n.length; s < o; s++) {
                    ...
                    a) {
                        var h = a._menu;
                        if (e(r).hasClass(dt) && !(i && ("click" === i.type && /input|textarea/i.test(i.target.tagName) || "keyup" === i.type && 9 === i.which) && e.contains(r, i.target))) {
                            ...
                            e(h).removeClass(dt),
                            e(r).removeClass(dt).trigger(e.Event(ct.HIDDEN, l)))
                        }
                    }
                }
        }
        ...
        t._dataApiKeydownHandler = function(i) {
            if ((/input|textarea/i.test(i.target.tagName) ? !(32 === i.which || 27 !== i.which && (40 !== i.which && 38 !== i.which || e(i.target).closest(yt).length)) : ht.test(i.which)) && (i.preventDefault(),
            i.stopPropagation(),
            !this.disabled && !e(this).hasClass(ut))) {
                var n = t._getParentFromElement(this)
                  , s = e(n).hasClass(dt);
                if (s && (!s || 27 !== i.which && 32 !== i.which)) {
                    var o = [].slice.call(n.querySelectorAll(Ct));
                    if (0 !== o.length) {
    ...
    e(document).on(ct.KEYDOWN_DATA_API, _t, Nt._dataApiKeydownHandler).on(ct.KEYDOWN_DATA_API, yt, Nt._dataApiKeydownHandler).on(ct.CLICK_DATA_API + " " + ct.KEYUP_DATA_API, Nt._clearMenus).on(ct.CLICK_DATA_API, _t, function(t) {
        t.preventDefault(),
        t.stopPropagation(),
    ...
    e.fn[at] = Nt._jQueryInterface,
    e.fn[at].Constructor = Nt,
      ...
      , Bt = function() {
        ...
        i.show = function(t) {
            ...
            if (!this._isShown && !this._isTransitioning) {
                ...
                e(this._element).on(Ht.CLICK_DISMISS, qt.DATA_DISMISS, function(t) {
                    return i.hide(t)
                }),
                e(this._dialog).on(Ht.MOUSEDOWN_DISMISS, function() {
                    e(i._element).one(Ht.MOUSEUP_DISMISS, function(t) {
        ...
        i.hide = function(t) {
            ...
            this._isShown && !this._isTransitioning) {
                var n = e.Event(Ht.HIDE);
                if (e(this._element).trigger(n),
                this._isShown && !n.isDefaultPrevented()) {
                    this._isShown = !1;
                    var s = e(this._element).hasClass(zt);
                    if (s && (this._isTransitioning = !0),
                    this._setEscapeEvent(),
                    this._setResizeEvent(),
                    e(document).off(Ht.FOCUSIN),
                    e(this._element).removeClass(jt),
                    e(this._element).off(Ht.CLICK_DISMISS),
                    e(this._dialog).off(Ht.MOUSEDOWN_DISMISS),
                    s) {
        ...
        i._showElement = function(t) {
            ...
            e(this._dialog).hasClass(Lt) ? this._dialog.querySelector(qt.MODAL_BODY).scrollTop = 0 : this._element.scrollTop = 0,
            n && h.reflow(this._element),
            e(this._element).addClass(jt),
            this._config.focus && this._enforceFocus();
            var s = e.Event(Ht.SHOWN, {
                relatedTarget: t
            })
              , o = function() {
        ...
        i._enforceFocus = function() {
            var t = this;
            e(document).off(Ht.FOCUSIN).on(Ht.FOCUSIN, function(i) {
        ...
        i._showBackdrop = function(t) {
            ...
            if (this._isShown && this._config.backdrop) {
                ...
                e(this._element).on(Ht.CLICK_DISMISS, function(t) {
                ...
                e(this._backdrop).one(h.TRANSITION_END, t).emulateTransitionEnd(s)
                ...
                if (e(this._element).hasClass(zt)) {
                    ...
                    e(this._backdrop).one(h.TRANSITION_END, o).emulateTransitionEnd(r)
                } else
                    o()
            } else
                t && t()
        ...
        i._setScrollbar = function() {
            ...
            if (this._isBodyOverflowing) {
                var i = [].slice.call(document.querySelectorAll(qt.FIXED_CONTENT))
                  , n = [].slice.call(document.querySelectorAll(qt.STICKY_CONTENT));
        ...
        i._resetScrollbar = function() {
            ...
            var i = [].slice.call(document.querySelectorAll("" + qt.STICKY_CONTENT));
        ...
        t._jQueryInterface = function(i, n) {
            return this.each(function() {
                var s = e(this).data("bs.modal")
                  , o = r({}, Ot, e(this).data(), "object" == typeof i && i ? i : {});
                if (s || (s = new t(this,o),
        ...
        for (var n = (new window.DOMParser).parseFromString(t, "text/html"), s = Object.keys(e), o = [].slice.call(n.body.querySelectorAll("*")), r = function(t, i) {
            ...
            a.forEach(function(t) {
                (function(t, e) {
                    ...
                    if (-1 !== e.indexOf(i))
                        return -1 === Yt.indexOf(i) || Boolean(t.nodeValue.match(Kt) || t.nodeValue.match($t));
      ...
      , pe = function() {
        ...
        n.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                this.setContent(),
                this.config.animation && e(r).addClass(oe);
                ...
                var d = function() {
                    ...
                    i === ne && t._leave(null, t)
                };
                if (e(this.tip).hasClass(oe)) {
                    var p = h.getTransitionDurationFromElement(this.tip);
                    e(this.tip).one(h.TRANSITION_END, d).emulateTransitionEnd(p)
                } else
                    d()
            }
        }
        ...
        n.hide = function(t) {
            ...
            !s.isDefaultPrevented()) {
                ...
                e(this.tip).hasClass(oe)) {
                    ...
                    e(n).one(h.TRANSITION_END, o).emulateTransitionEnd(r)
                } else
                    o();
                this._hoverState = ""
            }
        ...
        n.setContent = function() {
            ...
            e(t).removeClass(oe + " " + re)
        }
        ,
        n.setElementContent = function(t, i) {
            "object" != typeof i || !i.nodeType && !i.jquery ? this.config.html ? (this.config.sanitize && (i = Vt(i, this.config.whiteList, this.config.sanitizeFn)),
        ...
        n._setListeners = function() {
            ...
            this.config.trigger.split(" ").forEach(function(i) {
                if ("click" === i)
                    ...
                    var n = i === he ? t.constructor.Event.MOUSEENTER : t.constructor.Event.FOCUSIN
                      , s = i === he ? t.constructor.Event.MOUSELEAVE : t.constructor.Event.FOCUSOUT;
        ...
        n._enter = function(t, i) {
            ...
            t && (i._activeTrigger["focusin" === t.type ? ce : he] = !0),
            e(i.getTipElement()).hasClass(re) || i._hoverState === ie ? i._hoverState = ie : (clearTimeout(i._timeout),
            i._hoverState = ie,
        ...
        n._leave = function(t, i) {
            ...
            (i = i || e(t.currentTarget).data(n)) || (i = new this.constructor(t.currentTarget,this._getDelegateConfig()),
            e(t.currentTarget).data(n, i)),
            t && (i._activeTrigger["focusout" === t.type ? ce : he] = !1),
        ...
        n._getConfig = function(t) {
            ...
            h.typeCheckConfig(Xt, t, this.constructor.DefaultType),
        ...
        n._fixTransition = function() {
            ...
            null === t.getAttribute("x-placement") && (e(t).removeClass(oe),
    ...
    var fe = "popover"
      ...
      , Te = function(t) {
        ...
        r.setContent = function() {
            ...
            this.setElementContent(t.find(Ce), i),
            t.removeClass(be + " " + ye)
        }
        ,
    ...
    var ke = "scrollspy"
      ...
      , He = function() {
        function t(t, i) {
            ...
            e(this._scrollElement).on(Se.SCROLL, function(t) {
                return n._process(t)
            }),
            this.refresh(),
            this._process()
        ...
        return i.refresh = function() {
            var t = this
              , i = this._scrollElement === this._scrollElement.window ? Oe : Me
              , n = "auto" === this._config.method ? i : this._config.method
              , s = n === Me ? this._getScrollTop() : 0;
            this._offsets = [],
            this._targets = [],
        ...
        i._getConfig = function(t) {
            ...
            return h.typeCheckConfig(ke, t, Ie),
            t
        }
        ,
        ...
        i._activate = function(t) {
            ...
            n.hasClass(Ae) ? (n.closest(Pe.DROPDOWN).find(Pe.DROPDOWN_TOGGLE).addClass(Ne),
            n.addClass(Ne)) : (n.addClass(Ne),
            n.parents(Pe.NAV_LIST_GROUP).prev(Pe.NAV_LINKS + ", " + Pe.LIST_ITEMS).addClass(Ne),
            n.parents(Pe.NAV_LIST_GROUP).prev(Pe.NAV_ITEMS).children(Pe.NAV_LINKS).addClass(Ne)),
            e(this._scrollElement).trigger(Se.ACTIVATE, {
                relatedTarget: t
            })
        }
        ,
    ...
    e(window).on(Se.LOAD_DATA_API, function() {
        for (var t = [].slice.call(document.querySelectorAll(Pe.DATA_SPY)), i = t.length; i--; ) {
            var n = e(t[i]);
            He._jQueryInterface.call(n, n.data())
        }
    }),
    e.fn[ke] = He._jQueryInterface,
    e.fn[ke].Constructor = He,
      ...
      , Ge = function() {
        ...
        return i.show = function() {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && e(this._element).hasClass(Re) || e(this._element).hasClass(ze))) {
                var i, n, s = e(this._element).closest(Ye)[0], o = h.getSelectorFromElement(this._element);
                if (s) {
                    var r = "UL" === s.nodeName || "OL" === s.nodeName ? Ke : Ue;
        ...
        i._activate = function(t, i, n) {
            var s = this
              , o = (!i || "UL" !== i.nodeName && "OL" !== i.nodeName ? e(i).children(Ue) : e(i).find(Ke))[0]
              , r = n && o && e(o).hasClass(je)
              , a = function() {
                return s._transitionComplete(t, o, n)
            };
            if (o && r) {
                var l = h.getTransitionDurationFromElement(o);
                e(o).removeClass(qe).one(h.TRANSITION_END, a).emulateTransitionEnd(l)
            } else
                a()
        }
        ,
        i._transitionComplete = function(t, i, n) {
            if (i) {
                e(i).removeClass(Re);
                var s = e(i.parentNode).find(Xe)[0];
                s && e(s).removeClass(Re),
                "tab" === i.getAttribute("role") && i.setAttribute("aria-selected", !1)
            }
            if (e(t).addClass(Re),
            "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0),
            h.reflow(t),
            t.classList.contains(je) && t.classList.add(qe),
            t.parentNode && e(t.parentNode).hasClass(Fe)) {
                var o = e(t).closest(Be)[0];
                if (o) {
                    var r = [].slice.call(o.querySelectorAll(Ve));
                    e(r).addClass(Re)
                }
    ...
    e(document).on(We.CLICK_DATA_API, $e, function(t) {
        t.preventDefault(),
        Ge._jQueryInterface.call(e(this), "show")
    }),
      ...
      , ri = function() {
        ...
        return i.show = function() {
            ...
            this._config.animation) {
                ...
                e(this._element).one(h.TRANSITION_END, i).emulateTransitionEnd(n)
            } else
                i()
        }
        ,
        i.hide = function(t) {
            var i = this;
            this._element.classList.contains(ei) && (e(this._element).trigger(Je.HIDE),
        ...
        ,
        i._getConfig = function(t) {
            return t = r({}, si, e(this._element).data(), "object" == typeof t && t ? t : {}),
            h.typeCheckConfig("toast", t, this.constructor.DefaultType),
            t
        }
        ,
        i._setListeners = function() {
            var t = this;
            e(this._element).on(Je.CLICK_DISMISS, oi, function() {
                return t.hide(!0)
            })
        }
        ,
        i._close = function() {
            var t = this
              , i = function() {
                ...
                e(t._element).trigger(Je.HIDDEN)
            };
...
function(t) {
    ...
    function() {
        ...
        t.fn.position = function(n) {
            ...
            n = t.extend({}, n);
            var c, d, p, f, g, m, v = t(n.of), _ = t.position.getWithinInfo(n.within), b = t.position.getScrollInfo(_), y = (n.collision || "flip").split(" "), w = {};
            return m = function(e) {
                var i = e[0];
                return 9 === i.nodeType ? {
                    width: e.width(),
            ...
            1 === y.length && (y[1] = y[0]),
            "right" === n.at[0] ? g.left += d : "center" === n.at[0] && (g.left += d / 2),
            "bottom" === n.at[1] ? g.top += p : "center" === n.at[1] && (g.top += p / 2),
            c = e(w.at, d, p),
            g.left += c[0],
            g.top += c[1],
            this.each(function() {
                var r, a, l = t(this), h = l.outerWidth(), u = l.outerHeight(), m = i(this, "marginLeft"), C = i(this, "marginTop"), x = h + m + i(this, "marginRight") + b.width, T = u + C + i(this, "marginBottom") + b.height, k = t.extend({}, g), D = e(w.my, l.outerWidth(), l.outerHeight());
                "right" === n.my[0] ? k.left -= h : "center" === n.my[0] && (k.left -= h / 2),
                "bottom" === n.my[1] ? k.top -= u : "center" === n.my[1] && (k.top -= u / 2),
                k.left += D[0],
                k.top += D[1],
                r = {
                    marginLeft: m,
                ...
                t.each(["left", "top"], function(e, i) {
                    t.ui.position[y[e]] && t.ui.position[y[e]][i](k, {
                        targetWidth: d,
                        targetHeight: p,
                        elemWidth: h,
                        elemHeight: u,
    ...
    t.effects.define("bounce", function(e, i) {
        var n, s, o, r = t(this), a = e.mode, l = "hide" === a, h = "show" === a, c = e.direction || "up", u = e.distance, d = e.times || 5, p = 2 * d + (h || l ? 1 : 0), f = e.duration / p, g = e.easing, m = "up" === c || "down" === c ? "top" : "left", v = "up" === c || "left" === c, _ = 0, b = r.queue().length;
        ...
        r.css("opacity", 0).css(m, v ? 2 * -u : 2 * u).animate(s, f, g)),
        l && (u /= Math.pow(2, d - 1)),
        (s = {})[m] = o; d > _; _++)
            (n = {})[m] = (v ? "-=" : "+=") + u,
    ...
    t.effects.define("explode", "hide", function(e, i) {
        ...
        var s, o, r, a, l, h, c = e.pieces ? Math.round(Math.sqrt(e.pieces)) : 3, u = c, d = t(this), p = "show" === e.mode, f = d.show().css("visibility", "hidden").offset(), g = Math.ceil(d.outerWidth() / u), m = Math.ceil(d.outerHeight() / c), v = [];
        for (s = 0; c > s; s++)
            for (a = f.top + s * m,
            h = s - (c - 1) / 2,
            o = 0; u > o; o++)
    ...
    t.extend(e.prototype, {
        ...
        parseDate: function(e, i, n) {
            ...
            if ("" === (i = "object" == typeof i ? "" + i : i + ""))
                return null;
            var s, o, r, a, l = 0, h = (n ? n.shortYearCutoff : null) || this._defaults.shortYearCutoff, c = "string" != typeof h ? h : (new Date).getFullYear() % 100 + parseInt(h, 10), u = (n ? n.dayNamesShort : null) || this._defaults.dayNamesShort, d = (n ? n.dayNames : null) || this._defaults.dayNames, p = (n ? n.monthNamesShort : null) || this._defaults.monthNamesShort, f = (n ? n.monthNames : null) || this._defaults.monthNames, g = -1, m = -1, v = -1, _ = -1, b = !1, y = function(t) {
            ...
            _ > -1)
                for (m = 1,
                v = _; !((o = this._getDaysInMonth(g, m - 1)) >= v); )
                    m++,
                    v -= o;
        ...
        _generateHTML: function(t) {
            ...
            C = 0; K[0] > C; C++) {
                ...
                T = 0; K[1] > T; T++) {
                    ...
                    for (E += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + D + "'>" + (/all|left/.test(D) && 0 === C ? q ? o : n : "") + (/all|right/.test(D) && 0 === C ? q ? n : o : "") + this._generateMonthYearHeader(t, Z, tt, Q, J, C > 0 || T > 0, f, g) + "</div><table class='ui-datepicker-calendar'><thead><tr>",
                    I = u ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "",
                    w = 0; 7 > w; w++)
                        I += "<th scope='col'" + ((w + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[S = (w + c) % 7] + "'>" + p[S] + "</span></th>";
                    for (E += I + "</tr></thead><tbody>",
                    ...
                    ++Z > 11 && (Z = 0,
                    tt++),
                    x += E += "</tbody></table>" + (X ? "</div>" + (K[0] > 0 && T === K[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")
                }
                y += x
            }
            return y += h,
    ...
    t.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(e, i, n) {
            var s, o, r, a, l, h, c, u, d, p, f = n.options, g = f.snapTolerance, m = i.offset.left, v = m + n.helperProportions.width, _ = i.offset.top, b = _ + n.helperProportions.height;
            for (d = n.snapElements.length - 1; d >= 0; d--)
                ...
                l - g > v || m > h + g || c - g > b || _ > u + g || !t.contains(n.snapElements[d].item.ownerDocument, n.snapElements[d].item) ? (n.snapElements[d].snapping && n.options.snap.release && n.options.snap.release.call(n.element, e, t.extend(n._uiHash(), {
                    snapItem: n.snapElements[d].item
                })),
                n.snapElements[d].snapping = !1) : ("inner" !== f.snapMode && (s = g >= Math.abs(c - b),
                o = g >= Math.abs(u - _),
                r = g >= Math.abs(l - v),
                a = g >= Math.abs(h - m),
                ...
                p = s || o || r || a,
                "outer" !== f.snapMode && (s = g >= Math.abs(c - _),
                o = g >= Math.abs(u - b),
                r = g >= Math.abs(l - m),
                a = g >= Math.abs(h - v),
                s && (i.position.top = n._convertPositionTo("relative", {
    ...
    t.ui.plugin.add("resizable", "grid", {
        resize: function() {
            var e, i = t(this).resizable("instance"), n = i.options, s = i.size, o = i.originalSize, r = i.originalPosition, a = i.axis, l = "number" == typeof n.grid ? [n.grid, n.grid] : n.grid, h = l[0] || 1, c = l[1] || 1, u = Math.round((s.width - o.width) / h) * h, d = Math.round((s.height - o.height) / c) * c, p = o.width + u, f = o.height + d, g = n.maxWidth && p > n.maxWidth, m = n.maxHeight && f > n.maxHeight, v = n.minWidth && n.minWidth > p, _ = n.minHeight && n.minHeight > f;
            n.grid = l,
            v && (p += h),
            _ && (f += c),
            g && (p -= h),
    ...
    t.ui.ddmanager = {
        ...
        drop: function(e, i) {
            ...
            return t.each((t.ui.ddmanager.droppables[e.options.scope] || []).slice(), function() {
                this.options && (!this.options.disabled && this.visible && g(e, this, this.options.tolerance, i) && (n = this._drop.call(this, i) || n),
        ...
        drag: function(e, i) {
            ...
            t.each(t.ui.ddmanager.droppables[e.options.scope] || [], function() {
                if (!this.options.disabled && !this.greedyChild && this.visible) {
                    var n, s, o, r = g(e, this, this.options.tolerance, i), a = !r && this.isover ? "isout" : r && !this.isover ? "isover" : null;
...
function(t) {
    t.widget("ui.tagit", {
        ...
        _create: function() {
            ...
            this.element.addClass("tagit-hidden-field")) : this.tagList = this.element.find("ul, ol").addBack().last(),
            this.tagInput = t('<input type="text" />').addClass("ui-widget-content"),
            ...
            this.tagList.addClass("tagit").addClass("ui-widget ui-widget-content ui-corner-all").append(t('<li class="tagit-new"></li>').append(this.tagInput)).click(function(i) {
                var n = t(i.target);
                n.hasClass("tagit-label") ? (n = n.closest(".tagit-choice")).hasClass("removed") || e._trigger("onTagClicked", i, {
                    tag: n,
            ...
            this.tagInput.autocomplete(n).bind("autocompleteopen.tagit", function(t, i) {
        ...
        destroy: function() {
            ...
            this.tagList.remove()) : (this.element.children("li").each(function() {
                t(this).hasClass("tagit-new") ? t(this).remove() : (t(this).removeClass("tagit-choice ui-widget-content ui-state-default ui-state-highlight ui-corner-all remove tagit-choice-editable tagit-choice-read-only"),
        ...
        createTag: function(e, i, n) {
            ...
            if (!this.options.allowDuplicates && !this._isNew(e))
                return e = this._findTagByLabel(e),
                !1 !== this._trigger("onTagExists", null, {
                    existingTag: e,
                    duringInitialization: n
                }) && this._effectExists("highlight") && e.effect("highlight"),
                !1;
            ...
            this.options.readOnly ? r.addClass("tagit-choice-read-only") : (r.addClass("tagit-choice-editable"),
            i = t("<span></span>").addClass("ui-icon ui-icon-close"),
            i = t('<a><span class="text-icon">×</span></a>').addClass("tagit-close").append(i).click(function(t) {
                s.removeTag(r)
            }),
            r.append(i)),
            this.options.singleField || (o = o.html(),
            r.append('<input type="hidden" value="' + o + '" name="' + this.options.fieldName + '" class="tagit-hidden-field" />')),
            !1 !== this._trigger("beforeTagAdded", null, {
                tag: r,
                tagLabel: this.tagLabel(r),
                duringInitialization: n
            }) && (this.options.singleField && ((o = this.assignedTags()).push(e),
            this._updateSingleTagsField(o)),
            this._trigger("onTagAdded", null, r),
            this.tagInput.val(""),
            this.tagInput.parent().before(r),
...
function() {
    var t = document.getElementById("modal-on-small")
      , e = document.getElementById("show-modal")
      , i = document.getElementById("close-small-modal");
    null !== (e && i && t) && (e.onclick = function() {
    ...
    window.onclick = function(e) {
        e.target == t && t.classList.add("hide")
    }
    )
}(),
...
function() {
    var t = document.getElementById("checkbox-reviewer-interests");
    null != t && (t.onclick = function() {
        var e = document.getElementById("reviewerInterests");
        1 == t.checked ? e.classList.remove("hidden") : e.classList.add("hidden")
    }
    )
}(),
$(document).ready(function() {
    ...
    $("#less_keywords").click(function() {
        $(".keyword_item").each(function(t) {
            t > 4 && $(this).addClass("more-than-five")
        }),
        $(this).addClass("hide"),
...
$(document).ready(function() {
    $("#collapseButton").click(function() {
        $("#authorInfoCollapse").hasClass("show") ? ($("#more-authors-data-symbol").removeClass("hide"),
        $("#less-authors-data-symbol").addClass("hide")) : ($("#more-authors-data-symbol").addClass("hide"),
        $("#less-authors-data-symbol").removeClass("hide"))
    })
}),
function() {
    var t = $("#articleMainData")
      , e = $("#mainEntry").children()
      , i = $("#articleAbstractBlock").children()
      , n = "data-for-mobiles";
    function s() {
        null !== t && !t.hasClass(n) && window.innerWidth < 768 ? (e.unwrap(),
        i.unwrap(),
        t.addClass(n)) : null !== t && t.hasClass(n) && window.innerWidth >= 768 && (e.wrapAll("<div class='main_entry col-md-4' id='mainEntry'></div>"),
        i.wrapAll("<div class='article_abstract_block col-md-8' id='articleAbstractBlock'></div>"),
        t.removeClass(n))
    }
    s(),
...
if ($contextOptinGroup.length) {
    ...
    $roles.change(function() {
        var t = $(this).closest(".roles");
        t.find(":checked").length ? t.siblings(".context_privacy").addClass("context_privacy_visible") : t.siblings(".context_privacy").removeClass("context_privacy_visible")
    })
}
